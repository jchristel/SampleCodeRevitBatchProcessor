...
| Button Group | Description |
|---|---|
| [Purge Unused](purge_unused.md) | Purge unused line styles, fill patterns, line patterns, shared parameters, filters, legends, schedules, view templates, and unplaced views â€” with or without pre-selection |
...
3. Restart Revit â€” the **duHast** tab will appear in the ribbon.
