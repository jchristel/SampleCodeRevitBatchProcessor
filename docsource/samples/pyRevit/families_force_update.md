...
Use this button when you have edited a family file on disk but Revit is not detecting the change and refusing to reload it â€” typically because the file timestamp or internal checksum has not changed in a way Revit recognises.
