...
if (DU_HAST_PATH is None):
    # get the duHast directory within the hassell lib directory
    DUHAST_DIRECTORY = os.path.join(ROOT_DEVELOPMENT_DIRECTORY,r"hassell.lib\duHast")
else:
    DUHAST_DIRECTORY = os.path.join(DU_HAST_PATH, "duHast")

print("duHast dir: {}".format(DUHAST_DIRECTORY))
...
def get_settings():
    # look for settings file in %AppData/Local/hassell%
