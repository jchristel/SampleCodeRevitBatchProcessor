...
PURGE_ACTIONS.append( pA.PurgeAction('Purge Unused InPlace Railing Types', rRail.GetUnusedNonInPlaceRailingTypeIdsToPurge,'Railing Type(s)','Railing Type(s)',rRail.GetAllInPlaceRailingTypeIdsInModel))
