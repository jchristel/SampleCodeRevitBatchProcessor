...
- If the selected view filters does not exist in the target view templates, they will be added.
...
from views.view_overrides_filters import apply_filter_overrides_to_views


# propagate filter overrides from one template to many
apply_filter_overrides_to_views(doc=doc, add_filter_if_not_present=True, forms=forms)
