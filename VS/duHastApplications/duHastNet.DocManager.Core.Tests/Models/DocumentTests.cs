...
public class DocumentTests
{
    ...
    [Test]
    public void SetCustomProperty_NewProperty_AddsToCollection()
    {
        // Arrange
        var document = new Document("A-101", "Floor Plan", "1", 1);
        document.Id = 5; // Simulate database-assigned ID

        // Act
        document.SetCustomProperty("ProjectPhase", "Construction");

        // Assert
        Assert.That(document.CustomProperties.Count, Is.EqualTo(1));
        Assert.That(document.CustomProperties[0].PropertyName, Is.EqualTo("ProjectPhase"));
        Assert.That(document.CustomProperties[0].PropertyValue, Is.EqualTo("Construction"));
        Assert.That(document.CustomProperties[0].DocumentId, Is.EqualTo(5));
    }

    [Test]
    public void SetCustomProperty_ExistingProperty_UpdatesValue()
    {
        // Arrange
        var document = new Document("A-101", "Floor Plan", "1", 1);
        document.Id = 5;
        document.SetCustomProperty("ProjectPhase", "Design");
    ...
    [Test]
    public void GetCustomProperty_ExistingProperty_ReturnsValue()
    {
        // Arrange
        var document = new Document("A-101", "Floor Plan", "1", 1);
        document.SetCustomProperty("DisciplineCode", "ARCH");

        // Act
        var result = document.GetCustomProperty("DisciplineCode");

        // Assert
        Assert.That(result, Is.EqualTo("ARCH"));
    }

    [Test]
    public void GetCustomProperty_NonExistingProperty_ReturnsNull()
    {
        // Arrange
        var document = new Document("A-101", "Floor Plan", "1", 1);

        // Act
        var result = document.GetCustomProperty("NonExistent");
    ...
    [Test]
    public void GetCustomProperty_CaseInsensitive_ReturnsValue()
    {
        // Arrange
        var document = new Document("A-101", "Floor Plan", "1", 1);
        document.SetCustomProperty("ProjectPhase", "Construction");
        ...
        // Act
        var result = document.GetCustomProperty("projectphase");

        // Assert
        Assert.That(result, Is.EqualTo("Construction"));
    }
}