...
try
{
    ...
    Dictionary<string, string> ironPythonPaths = RBP_Launcher.Utilities.IronPythonInstall.GetIronPythonInstallPaths();
    foreach (string path in ironPythonPaths.Values)
    {
        Console.WriteLine(path);
    }
    string lastInstallPat = RBP_Launcher.Utilities.IronPythonInstall.GetLatestVersionInstallPath();
    Console.WriteLine($"Latest install path: {lastInstallPat}");
