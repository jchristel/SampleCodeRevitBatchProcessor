...
from families.swap_by_user_selection_pick import swap_instances_by_user_selection_pick_entry

swap_instances_by_user_selection_pick_entry(doc=doc,  uiapp= uiapp, output=output, forms=forms)