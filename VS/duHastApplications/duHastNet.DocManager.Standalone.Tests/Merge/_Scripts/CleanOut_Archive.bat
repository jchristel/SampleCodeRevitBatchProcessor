...
SET SCRIPT_PATH=%~dp0CleanOut.ps1

REM Set the target directory (change this to your desired path)
SET TARGET_DIR=C:\Users\janchristel\Documents\GitHub\SampleCodeRevitBatchProcessor-NET8\VS\duHastApplications\duHastNet.DocManager.Standalone.Tests\Merge\Archive
