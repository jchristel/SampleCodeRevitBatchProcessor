...
REM ---------------------------------------------------------------------------------------------------------------
REM ------------------------------------- processing arguments passt in --------------------------------------
REM
REM 1st argument: path to a directory of file containing files to be processed...if empty the hard coded default path will be used.
REM
REM ---------------------------------------------------------------------------------------------------------------

:: check if a path was passt in to be used to generate task lists
if "%~1"=="" goto bad
:: argument task file location (first arg)
set _filesLocation=%~f1

%stamp% & echo.
%stamp% & echo Using passed in path: %_filesLocation%
%stamp% & echo.
...
%stamp% & echo.
%stamp% & echo Using hard coded library path to get families
%stamp% & echo.

:: use a default value if no path passt in
set _filesLocation=""
...
set "_settingsStepOneFileName=BatchRvt.2022.FamilyCategoriesOne%%j.ALL.Settings.json"
...
call %_pythonPath% %_FileSelectPath% "%_filesLocation%"
