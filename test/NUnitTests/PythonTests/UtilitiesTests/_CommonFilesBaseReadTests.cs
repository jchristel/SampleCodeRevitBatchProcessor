...
namespace PythonTests.UtilitiesTests
{
    public static class _CommonFilesBaseReadTests
    {
        ...
        public static void WriteAndReadWithEncodingReportData_CreatesAndReadsReportFile_HeaderAndData(
                string tempDirectory,
                string delimiter,
                WriteReportDataDelegate writeReportData,
                ReadReportDataDelegate readReportData)
        ...
        public static void WriteAndReadWithEncodingReportData_CreatesAndReadsReportFile_HeaderOnly(
            string tempDirectory,
            string delimiter,
            WriteReportDataDelegate writeReportData,
            ReadReportDataDelegate readReportData)
        ...
        public static void WriteAndReadWithEncodingReportData_CreatesAndReadsReportFile_DataOnly(
            string tempDirectory,
            string delimiter,
            WriteReportDataDelegate writeReportData,
            ReadReportDataDelegate readReportData)
        ...
        public static void WriteAndReadWithEncodingReportData_CreatesAndReadsReportFileWithDelimiter_HeaderAndData(
            string tempDirectory,
            string delimiter,
            WriteReportDataDelegate writeReportData,
            ReadReportDataDelegate readReportData)
        ...
        public static void WriteAndReadWithEncodingReportData_CreatesAndReadsReportFileWithDelimiter_HeaderOnly(
            string tempDirectory,
            string delimiter,
            WriteReportDataDelegate writeReportData,
            ReadReportDataDelegate readReportData)
        ...
        public static void WriteAndReadWithEncodingReportData_CreatesAndReadsReportFileWithDelimiter_DataOnly(
            string tempDirectory,
            string delimiter,
            WriteReportDataDelegate writeReportData,
            ReadReportDataDelegate readReportData)
        ...
        public static void WriteAndReadWithEncodingReportData_CreatesAndReadsReportFileWithNonUtf8_HeaderAndData(
            string tempDirectory,
            string delimiter,
            WriteReportDataDelegate writeReportData,
            ReadReportDataDelegate readReportData)
        {
            ...
            // Check for the content
            Assert.That(readData[0], Is.EqualTo(header)); // Non-UTF-8 characters in header
            Assert.That(readData[1], Is.EqualTo(data[0])); // no non-utf8 characters in data
            Assert.That(readData[2], Is.EqualTo(data[1])); // Non-UTF-8 character in data
        }


        public static void WriteAndReadWithEncodingReportData_CreatesAndReadsReportFileWithNonUtf8_HeaderOnly(
            string tempDirectory,
            string delimiter,
            WriteReportDataDelegate writeReportData,
            ReadReportDataDelegate readReportData)
        ...
        public static void WriteAndReadWithEncodingReportData_CreatesAndReadsReportFileWithNonUtf8_DataOnly(
            string tempDirectory,
            string delimiter,
            WriteReportDataDelegate writeReportData,
            ReadReportDataDelegate readReportData)
        ...
        public static void WriteAndReadWithEncodingReportData_CreatesAndReadsReportFileWithDelimiterAndUtf8_HeaderAndData(
            string tempDirectory,
            string delimiter,
            WriteReportDataDelegate writeReportData,
            ReadReportDataDelegate readReportData)
        ...
        public static void WriteAndReadWithEncodingReportData_CreatesAndReadsReportFileWithDelimiterAndUtf8_HeaderOnly(
            string tempDirectory,
            string delimiter,
            WriteReportDataDelegate writeReportData,
            ReadReportDataDelegate readReportData)
        ...
        public static void WriteAndReadWithEncodingReportData_CreatesAndReadsReportFileWithDelimiterAndUtf8_DataOnly(
            string tempDirectory,
            string delimiter,
            WriteReportDataDelegate writeReportData,
            ReadReportDataDelegate readReportData)
        {
            ...
            // Check for the content
            Assert.That(readData[0], Is.EqualTo(data[0]));
            Assert.That(readData[1], Is.EqualTo(data[1])); // Non-UTF-8 character in data
        }


        public static void WriteAndReadWithEncodingReportData_CreatesAndReadsReportFileWithMaxFieldSizeLimit_HeaderAndData(
            string tempDirectory,
            string delimiter,
            WriteReportDataDelegate writeReportData,
            ReadReportDataDelegate readReportData)
