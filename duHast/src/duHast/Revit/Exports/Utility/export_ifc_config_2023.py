...
def ifc_get_third_party_export_config_by_view_2023(ifc_version, ifc_settings):
    ...
    if(ifc_settings == None):
        ifc_export_config = _setup_config_default_values_2023(ifc_export_config, ifc_version, True)
    else:
        ifc_export_config = _setup_config_from_settings_2023(ifc_export_config, ifc_settings)
...
def ifc_get_third_party_export_config_by_model_2023(ifc_version, ifc_settings):
    ...
    ifc_export_config = IFCExportConfiguration.CreateDefaultConfiguration()
    if(ifc_settings == None):
        ifc_export_config = _setup_config_default_values_2023(ifc_export_config, ifc_version, False)
    else:
        ifc_export_config = _setup_config_from_settings_2023(ifc_export_config, ifc_settings)
