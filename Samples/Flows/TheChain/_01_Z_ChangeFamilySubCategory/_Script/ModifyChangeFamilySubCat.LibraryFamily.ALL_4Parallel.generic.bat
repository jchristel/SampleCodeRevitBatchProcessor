...
if %toggleDebug%==1 (
  ...
  %stamp% & echo _FileBuilderPath: %_FileBuilderPath%
...
%stamp% & echo.
%stamp% & echo Starting file list builder ... 
...
%stamp% & echo.
%stamp% & echo Starting task bucket builder
...
:: errorhandling, errorlevel >= 1
%stamp% & echo Task bucket builder failed with an exception. Exiting now...
exit
