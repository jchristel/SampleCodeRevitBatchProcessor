...
Use this button when you need native Revit rooms for area scheduling, room tagging, or other workflows that require the built-in Revit room type â€” while keeping the mock rooms as the primary design layout tool.
...
- If a room already exists at a mock room's location, a duplicate may be created â€” review the model after running.
