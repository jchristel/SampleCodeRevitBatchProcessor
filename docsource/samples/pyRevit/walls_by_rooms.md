...
Use this button when you want to convert a room-based layout (defined using room separation lines or boundaries) into actual wall geometry â€” for example, when transitioning from a schematic layout to a more detailed design.
