namespace PythonTests.UtilitiesTests
{
    public static class FileBaseTestsData
    {
        ...
        public static (string fileName, List<string> header, List<List<string>> data) StandardTestData_HeaderAndData(string tempDirectory)
        {
        ...
        public static (string fileName, List<string> header, List<List<string>> data) StandardTestData_HeaderOnly(string tempDirectory)
        {
            string fileName = Path.Combine(tempDirectory, "report.csv");
            List<string> header = new List<string> { "Header1", "Header2" };
        ...
        public static (string fileName, List<string> header, List<List<string>> data) StandardTestData_DataOnly(string tempDirectory)
        {
            string fileName = Path.Combine(tempDirectory, "report.csv");
        ...
        public static (string fileName, List<string> header, List<List<string>> data) DelimitedTestData_DataOnly(string tempDirectory)
        {
            // Arrange
            string fileName = Path.Combine(tempDirectory, "report.csv");
            List<string> header = new List<string> (); // No header
            List<List<string>> data = new List<List<string>>
            {
                ...
                new List<string> { "Value3", "Value4;Part4" }
            };
            return (fileName, header, data);
        }

        public static (string fileName, List<string> header, List<List<string>> data) DelimitedTestData_HeaderOnly(string tempDirectory)
        {
            // Arrange
            string fileName = Path.Combine(tempDirectory, "report.csv");
        ...
        public static (string fileName, List<string> header, List<List<string>> data) DelimitedTestData_HeaderAndData(string tempDirectory)
        {
            // Arrange
            string fileName = Path.Combine(tempDirectory, "report.csv");
        ...
        public static (string fileName, List<string> header, List<List<string>> data) NonASCIITestData(string tempDirectory)
        {
            string fileName = Path.Combine(tempDirectory, "report.csv");
            List<string> header = new List<string> { "Header1", "Header2" };
            List<List<string>> data = new List<List<string>>
        ...
        public static (string fileName, List<string> header, List<List<string>> data) NonUTF8TestData_HeaderOnly(string tempDirectory)
        {
            // Arrange
            string fileName = Path.Combine(tempDirectory, "report.csv");
        ...
        public static (string fileName, List<string> header, List<List<string>> data) NonUTF8TestData_HeaderAndData(string tempDirectory)
        {
            string fileName = Path.Combine(tempDirectory, "report.csv");
            List<string> header = new List<string> { "Hëader1", "Hëader2" }; // Non-UTF-8 characters in header
            List<List<string>> data = new List<List<string>>
        ...
        public static (string fileName, List<string> header, List<List<string>> data) NonUTF8AndDelimitedTestData_HeaderOnly(string tempDirectory)
        {
            // Arrange
            string fileName = Path.Combine(tempDirectory, "report.csv");
            List<string> header = new List<string> { "Hëader1;Part1", "Hëader2;Part2" }; // Non-UTF-8 characters and delimiter in header
        ...
        public static (string fileName, List<string> header, List<List<string>> data) ArrangeMaxFieldSizeTestData(string tempDirectory)
        {
            // Arrange
            string fileName = Path.Combine(tempDirectory, "report.csv");
            List<string> header = new List<string> { "Header1", "Header2" };
