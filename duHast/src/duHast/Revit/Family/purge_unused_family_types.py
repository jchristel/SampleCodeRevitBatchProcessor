...
from duHast.Revit.Family.family_utils import get_family_symbols_ids, get_symbols_from_type
from duHast.Revit.Family.Utility.loadable_family_categories import CATEGORIES_LOADABLE_TAGS, CATEGORIES_LOADABLE_3D
...
def get_used_unused_type_ids(doc, type_id_getter, use_type = 0, exclude_shared_fam = True):
    ...
    all_loadable_three_d_type_ids = type_id_getter(doc, CATEGORIES_LOADABLE_3D, exclude_shared_fam)
    all_loadable_tags_type_ids = type_id_getter(doc, CATEGORIES_LOADABLE_TAGS, exclude_shared_fam)
