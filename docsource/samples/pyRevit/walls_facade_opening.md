...
Use this button in projects where the architectural brief defines spaces by their facade opening dimensions rather than internal wall arrangements â€” for example, in faÃ§ade-driven residential or hospitality layouts where each unit is defined by its facade module.
