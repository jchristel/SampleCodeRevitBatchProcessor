...
**Use when:** You need a structured list of element IDs â€” for example, to feed into a Revit Batch Processor task or to audit which rooms belong to which design option.
