...
A pulldown containing tools to rename families and family types â€” both within the current Revit project and on disk in a library folder.
...
- Renaming on disk does not automatically update families already loaded in any open projects â€” use **Reload Families** afterwards if needed.
