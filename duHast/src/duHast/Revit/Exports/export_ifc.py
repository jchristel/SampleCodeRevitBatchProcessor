...
from duHast.Revit.Exports.Utility.export_ifc_config_2019 import ifc_get_third_party_export_config_by_model_2019, ifc_get_third_party_export_config_by_view_2019
from duHast.Revit.Exports.Utility.export_ifc_config_2020 import ifc_get_third_party_export_config_by_model_2020, ifc_get_third_party_export_config_by_view_2020
from duHast.Revit.Exports.Utility.export_ifc_config_2021 import ifc_get_third_party_export_config_by_model_2021, ifc_get_third_party_export_config_by_view_2021
from duHast.Revit.Exports.Utility.export_ifc_config_2022 import ifc_get_third_party_export_config_by_model_2022, ifc_get_third_party_export_config_by_view_2022
...
def export_to_ifc(doc, ifc_export_option, directory_path, file_name):
    ...
    def action():
        ...
        try:
            ...
            action_return_value.update_sep(True, 'Exported: {}'.format(directory_path + '\\' + str(file_name)))
            ...
            action_return_value.update_sep(False, 'Script Exception: Failed to export to IFC with exception: {}'.format(e))
...
def export_3d_views_to_ifc_default(doc, view_filter, ifc_export_option, directory_path):
    ...
    if(len(views_to_export) > 0):
        for export_view in views_to_export:
            ...
            file_name = build_export_file_name_from_view(export_view.Name, view_filter, '.ifc')
            return_value_by_view = export_to_ifc(doc, ifc_export_option, directory_path, file_name)
            return_value.update(return_value_by_view)
    else:
        return_value.update_sep(True, 'No 3D views found matching filter...nothing was exported')
    return return_value


def setup_ifc_export_option(export_config, view_id = rdb.ElementId.InvalidElementId, coord_option = IFCCoords.shared_coordinates):
    '''
...
def ifc_get_third_party_export_config_by_model(doc, ifc_version, ifc_settings = None):
    ...
    if (revit_version == 2019):
        ifc_config = ifc_get_third_party_export_config_by_model_2019(ifc_version, ifc_settings)
    elif (revit_version == 2020):
        ifc_config = ifc_get_third_party_export_config_by_model_2020(ifc_version, ifc_settings)
    elif (revit_version == 2021):
        ifc_config = ifc_get_third_party_export_config_by_model_2021(ifc_version, ifc_settings)
    elif (revit_version == 2022):
        ifc_config = ifc_get_third_party_export_config_by_model_2022(ifc_version, ifc_settings)
...
def ifc_get_third_party_export_config_by_view(doc, ifc_version, ifc_settings = None):
    ...
    ifc_config = None
    if (revit_version == 2019):
        ifc_config = ifc_get_third_party_export_config_by_view_2019(ifc_version, ifc_settings)
    elif (revit_version == 2020):
        ifc_config = ifc_get_third_party_export_config_by_view_2020(ifc_version, ifc_settings)
    elif (revit_version == 2021):
        ifc_config = ifc_get_third_party_export_config_by_view_2021(ifc_version, ifc_settings)
    elif (revit_version == 2022):
        ifc_config = ifc_get_third_party_export_config_by_view_2022(ifc_version, ifc_settings)
    elif(revit_version==2023):
